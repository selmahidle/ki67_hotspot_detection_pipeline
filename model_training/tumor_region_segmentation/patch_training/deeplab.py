...
run = wandb.init(
    ...
    config={
        ...
        "optimizer": "Adam",
        "model_architecture": "DeepLabV3+ ResNet18 (scratch)",
        "normalization": "Batch",
...
for epoch in range(args.num_epochs):
    ...
    with torch.no_grad():
        ...
        if avg_dice_value > best_metric:
                ...
                checkpoint_filename = f"/cluster/home/selmahi/mib_pipeline_scripts/checkpoints/cell_deeplabresnet_scratch/{args.slurm_job_id}_best_tumorseg_resnet_patch_model.pth"
