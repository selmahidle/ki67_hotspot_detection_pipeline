"""
U-Net training script for semantic segmentation of tumor cells in 1024x1024 WSIs patches
"""
...
for epoch in range(args.num_epochs):
    ...
    with torch.no_grad():
        ...
        if avg_dice_value > best_metric:
            ...
            checkpoint_filename = f"/cluster/home/selmahi/mib_pipeline/mib_pipeline_scripts/checkpoints/cell_unet/{args.slurm_job_id}_best_semseg_unet_model.pth"
