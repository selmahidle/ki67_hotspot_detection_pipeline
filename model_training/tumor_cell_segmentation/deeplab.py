"""
ResNet18 + DeepLabV3Plus trained for semantic segmentation of tumor cells in WSIs
"""
...
run = wandb.init(
    ...
    config={
        ...
        "optimizer": "Adam",
        "model_architecture": "DeepLabV3+ ResNet18", 
...
for epoch in range(args.num_epochs):
    ...
    with torch.no_grad():
        ...
        if avg_dice_value > best_metric:
                ...
                checkpoint_filename = f"/cluster/home/selmahi/mib_pipeline_scripts/checkpoints/cell_deeplabresnet_scratch/{args.slurm_job_id}_best_semseg_unet_model.pth"
                torch.save(model.state_dict(), checkpoint_filename)

del val_inputs, val_masks, val_outputs, inputs, masks, outputs, loss, val_loss
torch.cuda.empty_cache()

print(f"\nTraining complete. Best Validation Dice: {best_metric:.4f} achieved at epoch {best_metric_epoch}")
